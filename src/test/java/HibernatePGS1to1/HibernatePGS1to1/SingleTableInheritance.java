...
import inheritance.single.table.BankAccount;
import inheritance.single.table.CreditCard;
...
public class SingleTableInheritance {
	...
	public void clearDB(){
        ...
        session.createQuery("delete from inheritance.single.table.BillingDetails").executeUpdate();
        session.flush();
        tx.commit();
        session.close();
	}
	...
	public void saveBankAccount(){
        ...
        tx.commit();
        List<BankAccount> accounts = session.createQuery("from inheritance.single.table.BankAccount ba").list();
	...
	public void saveCreditCard(){
        ...
        tx.commit();
        List<CreditCard> creditCards = session.createQuery("from inheritance.single.table.CreditCard cd").list();
